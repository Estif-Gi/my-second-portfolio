...
const Home = () => {
    ...
    return ( 
        <>
        <div className="sm:flex justify-self-center md:gap-24 lg:gap-72 m-4">
            <img className="motion-preset-slide-right motion-duration-2000 w-52 rounded-full sm:w-96 ml-4 flex justify-self-center" src="..\..\images\profile-2.jpg" alt=""/>
