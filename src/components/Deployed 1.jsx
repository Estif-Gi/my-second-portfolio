const Deployed = () => {
    return ( 
        <>
            ...
            <div className="pl-5 sm:pl-10 border rounded-3xl m-5 shadow-gray-500 shadow-md flex flex-col sm:grid grid-cols-2 p-10  pt-5 ">
            ...
            <div className="pl-3 sm:pl-10 border rounded-3xl m-5 shadow-gray-500 shadow-md flex flex-col-reverse sm:grid grid-cols-2 p-10 ">
                ...
                <div className="flex p-5 w-72 md:w-[80%] justify-center ">
                    <a href="https://recipe-sharing-platform-ruddy.vercel.app/" 
                        ...
                        >
                            <img 
                            className="rounded-3xl min-w-72"
